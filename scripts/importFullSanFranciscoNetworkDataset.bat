...
FOR %%V IN (Car_NoToll Truck_NoToll) DO (
  python %DTA_CODE_DIR%\scripts\importCubeDemand.py . sf_trn Y:\dta\SanFrancisco\2010\demand\SanFranciscoSubArea_2010_PM.csv %%V 15:30 18:30 15:30 18:30 03:00 1.00 demand_%%V.dat 
  IF ERRORLEVEL 1 goto done
)
