# -*- coding: utf-8 -*-
#
# SFCTA Modeling documentation build configuration file, created by
...
latex_documents = [
  ('index', 'DTA Anyway.tex', u'DTA Anyway Documentation',
   u'DTA Anyway Crew', 'manual'),
]
...
man_pages = [
    ('index', 'DTA Anyway', u'DTA Anyway Documentation',
     [u'DTA Anyway Crew'], 1)
]
